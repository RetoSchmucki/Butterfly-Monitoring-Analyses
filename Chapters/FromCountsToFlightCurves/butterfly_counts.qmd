...
In the first scenario, we apply the method to a simple case where we have a univoltine species monitored over 15 years at 100 sites, where populations follow the same trend with a known growth rate.
